...
-- Description:	Retorna el producto dado el codigo que sea mayor o igual a la Existencia MAX
-- =============================================
CREATE PROCEDURE [dbo].[CO_SP_SELECT_ARTICULO_EXI_MAX] 
...
FROM         CO_ARTICULO
WHERE     (CO_EMP_RUC = @CO_EMP_RUC) AND (CO_ART_COD = @CO_ART_COD) AND (CO_ART_EXI_MAX <= @CO_ART_EXI)
