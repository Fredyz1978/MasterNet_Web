...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_SELECT_REPORTE_DOCUMENTOS_COMPRAS_RESUMIDO]
@CO_EMP_RUC CHAR(13)
...
FROM CO_VW_SELECT_LISTADO_COMPRAS
WHERE 
...
CO_TIP_COM_COM_COD=case @CO_TIP_COM_COM_COD when 0 then CO_TIP_COM_COM_COD else @CO_TIP_COM_COM_COD end  
order by CO_DOC_COM_FEC_EMI
--AND CO_ALM_COD=case @CO_ALM_COD when '' then CO_ALM_COD else @CO_ALM_COD end
GO
