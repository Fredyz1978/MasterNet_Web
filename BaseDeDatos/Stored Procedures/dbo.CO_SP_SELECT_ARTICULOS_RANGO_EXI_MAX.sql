...
-- Description:	Devuelve los productos cuyo stock este dentro del ran
-- =============================================
CREATE PROCEDURE [dbo].[CO_SP_SELECT_ARTICULOS_RANGO_EXI_MAX] 
...
BEGIN
	...
	FROM         CO_ARTICULO
	WHERE     (CO_EMP_RUC = @CO_EMP_RUC) AND ((@CO_ART_EXI >= CO_ART_EXI_MAX * (1-((SELECT     CO_OPT_CONF_NOT_STO_POR_MAX
