...
CREATE PROC [dbo].[CO_SP_INSERT_DOCUMENTO_COMPRA]
...
@CO_DOC_COM_CHE_FEC datetime,
@AlmacenID int,
@CO_DOC_COM_TRA bit
,@CO_DOC_COM_TRA_VAL float
,@CO_DOC_COM_TRA_DOC_NUM varchar(20)
AS
INSERT INTO [dbo].[CO_DOCUMENTO_COMPRA]
           (CO_DOC_COM_ID
           ,[CO_DOC_COM_NUM]
           ,[CO_PRO_COD]
           ,[CO_EMP_RUC]
