...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_SELECT_REPORTE_CARTERA_DETALLADO]
@CO_EMP_RUC CHAR(13)
...
AS
IF @CO_CAR_OPC='T'
SELECT *,@CO_DOC_VEN_FEC1,@CO_DOC_VEN_FEC2 FROM CO_VW_SELECT_REPORTE_CARTERA
WHERE CO_EMP_RUC=@CO_EMP_RUC AND 
Convert(varchar(10),CO_DOC_VEN_FEC,103)>=Convert(varchar(10),@CO_DOC_VEN_FEC1,103) AND
Convert(varchar(10),CO_DOC_VEN_FEC,103)<=Convert(varchar(10),@CO_DOC_VEN_FEC2,103)
IF @CO_CAR_OPC='O'
SELECT *,@CO_DOC_VEN_FEC1,@CO_DOC_VEN_FEC2 FROM CO_VW_SELECT_REPORTE_CARTERA
