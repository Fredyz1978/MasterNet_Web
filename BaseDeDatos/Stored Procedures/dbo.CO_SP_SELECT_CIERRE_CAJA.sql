...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_SELECT_CIERRE_CAJA]
@CO_EMP_RUC CHAR(13),
...
AND DV.CO_EMP_RUC=@CO_EMP_RUC AND CO_DOC_VEN_EST='ACTIVA' AND DV.CO_TIP_DOC_VEN_NUM<>4
union 
--NOTAS DE CRÉDITO
SELECT DV.CO_DOC_VEN_NUM, C.CO_CLI_NOM, 
...
AND DV.CO_EMP_RUC=@CO_EMP_RUC AND DV.CO_DOC_VEN_EST='ACTIVA'
...
AND DV.CO_EMP_RUC=@CO_EMP_RUC AND CO_COM_COB_CLI_EST='ACTIVA'
group by DV.CO_COM_COB_CLI_NUM, C.CO_CLI_NOM
order by 1
GO
