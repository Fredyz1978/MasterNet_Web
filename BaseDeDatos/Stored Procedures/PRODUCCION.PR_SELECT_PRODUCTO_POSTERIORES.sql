...
SET ANSI_NULLS ON
GO
CREATE PROC [PRODUCCION].[PR_SELECT_PRODUCTO_POSTERIORES]
@CO_EMP_RUC CHAR(13),
...
SELECT RANK() OVER (PARTITION BY PRODUCCION.KARDEX.PR_PRO_COD ORDER BY PRODUCCION.KARDEX.CO_KAR_TOT_COD DESC) AS 'RowNumber',		
				PRODUCCION.PRODUCTO.PR_PRO_COD, 
                      ...
                      PRODUCCION.PRODUCTO.PR_PRO_NOM, PRODUCCION.PRODUCTO.PR_PRO_UNI, PRODUCCION.PRODUCTO.PR_PRO_PES, CO_KAR_TOT_ENT_CANT, CO_KAR_TOT_ENT_VAL_UNI, 
						CO_KAR_TOT_ENT_VAL_TOT, CO_KAR_TOT_SAL_CANT, CO_KAR_TOT_SAL_VAL_TOT,
...
select PR_PRO_COD, CO_EMP_RUC, PR_TIP_REC_COD, PR_PRO_NOM, PR_PRO_UNI, PR_PRO_PES, CO_KAR_TOT_EXI_CANT, 
		CO_KAR_TOT_EXI_VAL_TOT, CO_KAR_TOT_EXI_VAL_UNI, CO_KAR_TOT_ENT_CANT, CO_KAR_TOT_ENT_VAL_TOT, CO_KAR_TOT_COD
		, CO_KAR_TOT_SAL_CANT, CO_KAR_TOT_SAL_VAL_TOT, CO_KAR_TOT_FEC, CO_KAR_TOT_ENT_VAL_UNI
from (
		...
		CO_KAR_TOT_ENT_CANT, CO_KAR_TOT_ENT_VAL_TOT, CO_KAR_TOT_COD , CO_KAR_TOT_SAL_CANT, CO_KAR_TOT_SAL_VAL_TOT, CO_KAR_TOT_FEC, CO_KAR_TOT_ENT_VAL_UNI
		FROM S) as X
