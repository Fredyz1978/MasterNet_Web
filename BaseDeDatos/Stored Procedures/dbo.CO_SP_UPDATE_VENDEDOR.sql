...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_UPDATE_VENDEDOR]
...
AS
UPDATE [dbo].[CO_VENDEDOR] SET
[CO_VEN_NOM]=@CO_VEN_NOM
,[CO_VEN_DIR]=@CO_VEN_DIR
,[CO_VEN_TEL]=@CO_VEN_TEL
,[CO_VEN_CEL]=@CO_VEN_CEL
,[CO_VEN_CTA]=@CO_VEN_CTA
,CO_VEN_EMAIL=@CO_VEN_EMAIL
