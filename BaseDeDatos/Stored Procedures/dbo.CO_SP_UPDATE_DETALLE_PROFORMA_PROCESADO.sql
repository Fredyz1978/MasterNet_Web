...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_UPDATE_DETALLE_PROFORMA_PROCESADO]
@CO_PRO_COD INT
,@CO_EMP_RUC CHAR(13)
,@CO_ART_COD VARCHAR(50)
,@CANTIDAD INT
AS
UPDATE [dbo].[CO_DETALLE_PROFORMA] SET CANTIDAD_FACTURAR=0, [CANTIDAD_PROCESADA]=CANTIDAD_PROCESADA+@CANTIDAD
