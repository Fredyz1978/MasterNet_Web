...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[CO_SP_SELECT_BUSQUEDA_ACTIVO_CODIGO]
@CO_EMP_COD CHAR(13)
...
WHERE dbo.CO_ACTIVO_FIJO.CO_EMP_RUC=@CO_EMP_COD AND dbo.CO_ACTIVO_FIJO.CO_ACT_FIJ_COD=@CO_ACT_FIJ_COD
GO
