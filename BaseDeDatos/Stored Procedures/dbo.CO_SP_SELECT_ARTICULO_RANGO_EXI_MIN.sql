...
-- Description:	Devuelve el producto cuyo stock esta dentro del rango de Existencia MIN
-- =============================================
CREATE PROCEDURE [dbo].[CO_SP_SELECT_ARTICULO_RANGO_EXI_MIN] 
...
BEGIN
	...
	FROM         CO_ARTICULO
	WHERE     (CO_ART_COD = @CO_ART_COD) AND (CO_EMP_RUC = @CO_EMP_RUC) AND ((@CO_ART_EXI <= CO_ART_EXI_MIN * (1+((SELECT     CO_OPT_CONF_NOT_STO_POR_MIN
