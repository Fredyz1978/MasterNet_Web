...
SET ANSI_NULLS ON
GO
CREATE PROC [PRODUCCION].[PR_SELECT_AGREGADO_ANTERIOR]
@PR_AGR_MES INT
,@PR_AGR_ANO INT
AS
...
PRODUCCION.TIPO_PROCESO ON PRODUCCION.AGREGADO.PR_TIP_PRO_COD = PRODUCCION.TIPO_PROCESO.PR_TIP_PRO_COD
WHERE (PRODUCCION.AGREGADO.PR_AGR_MES = @PR_AGR_MES) AND (PRODUCCION.AGREGADO.PR_AGR_ANO = @PR_AGR_ANO) AND 
(PRODUCCION.TIPO_PROCESO.PR_TIP_PRO_DES = 1)
GO
