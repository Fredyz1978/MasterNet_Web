...
CREATE VIEW [dbo].[CO_VW_SELECT_DOCUMENTO_VENTA_PENDIENTE]
AS
SELECT        dbo.CO_CLIENTE.CO_CLI_NOM, dbo.CO_CLIENTE.CO_CLI_COD, dbo.CO_CLIENTE.CO_CLI_CED, dbo.CO_CLIENTE.CO_CLI_TEL, dbo.CO_CLIENTE.CO_CLI_DIR, dbo.CO_CLIENTE.CO_CLI_CIU, 
                         ...
                         dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_OTR, dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_DET, dbo.CO_CLIENTE.CO_CLI_MAI, dbo.CO_EMPRESA.CO_CONTRIBUYENTE_ESPECIAL, 
                         dbo.CO_EMPRESA.CO_CONTRIBUYENTE_NUMERO, dbo.CO_EMPRESA.CO_OBLIGADO_CONTABILIDAD, dbo.CO_EMPRESA.CO_EMPRESA_LOGO, dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_ID, 
                         dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_VAL_ICE, dbo.CO_DOCUMENTO_VENTA.AlmacenID, dbo.CO_DOCUMENTO_ELECTRONICO.CO_FECHA_AUTORIZA_FACT_ELECTRONICA, 
                         ...
                         ('0'+cast(dbo.CO_TIPO_IDENTIFICACION.CO_TIP_IDE_COD as varchar(2))) as CO_TIP_IDE_COD_SRI,
                             (SELECT       DV. CO_DOC_VEN_NUM
                               FROM            dbo.CO_DOCUMENTO_VENTA AS DV
                               WHERE        (DV.CO_DOC_VEN_ID=dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_ORIGINAL_ID)) AS CO_DOC_VEN_MOD_NUM,
                             (SELECT        DV.CO_DOC_VEN_FEC
                               FROM            dbo.CO_DOCUMENTO_VENTA AS DV
                               WHERE        (DV.CO_DOC_VEN_ID = dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_ORIGINAL_ID)) AS CO_DOC_VEN_FEC_MOD, ISNULL(dbo.CO_DOCUMENTO_ELECTRONICO.CO_ESTADO_FACTURA_ELECTRONICA, 1) 
                         AS CO_ESTADO_FACTURA_ELECTRONICA
FROM            dbo.CO_TIPO_IDENTIFICACION INNER JOIN
                         ...
                         dbo.CO_DOCUMENTO_ELECTRONICO ON dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_ID = dbo.CO_DOCUMENTO_ELECTRONICO.CO_DOCUMENTO_ID

where dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_EST<>'ANULADA'
