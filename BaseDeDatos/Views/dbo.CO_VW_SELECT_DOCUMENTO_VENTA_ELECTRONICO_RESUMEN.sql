...
CREATE VIEW [dbo].[CO_VW_SELECT_DOCUMENTO_VENTA_ELECTRONICO_RESUMEN]
AS
SELECT        dbo.CO_CLIENTE.CO_CLI_NOM, dbo.CO_CLIENTE.CO_CLI_COD, dbo.CO_CLIENTE.CO_CLI_CED, dbo.CO_CLIENTE.CO_CLI_TEL, dbo.CO_CLIENTE.CO_CLI_DIR, dbo.CO_CLIENTE.CO_CLI_CIU, 
                         ...
                         dbo.CO_TIPO_IDENTIFICACION.CO_TIP_IDE_COD_SRI,
                             ...
                             (SELECT        CO_DOC_VEN_FEC
                               FROM            dbo.CO_DOCUMENTO_VENTA AS DV
                               WHERE        (CO_DOC_VEN_ID = dbo.CO_DOCUMENTO_VENTA.CO_DOC_VEN_ORIGINAL_ID)) AS CO_DOC_VEN_FEC_MOD, ISNULL(dbo.CO_DOCUMENTO_ELECTRONICO.CO_ESTADO_FACTURA_ELECTRONICA, 1) 
                         AS CO_ESTADO_FACTURA_ELECTRONICA, dbo.CO_VENDEDOR.CO_VEN_EMAIL, dbo.CO_CLIENTE.CO_CLI_MAI2, dbo.CO_CLIENTE.CO_CLI_MAI3
