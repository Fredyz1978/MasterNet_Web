...
CREATE VIEW [dbo].[CO_VW_SELECT_RETENCION_ELECTRONICA]
AS
SELECT        dbo.CO_RETENCION.CO_RET_COD, dbo.CO_RETENCION.CO_EMP_RUC, dbo.CO_RETENCION.CO_DOC_COM_ID, dbo.CO_RETENCION.CO_RET_SER1, dbo.CO_RETENCION.CO_RET_SER2, 
                         ...
                         dbo.CO_DOCUMENTO_ELECTRONICO.CO_ESTADO_FACTURA_ELECTRONICA, dbo.CO_DOCUMENTO_ELECTRONICO.CO_FECHA_REGISTRO, dbo.CO_PROVEEDOR.CO_PRO_MAI, dbo.CO_EMPRESA.CO_EMP_NOM, 
                         dbo.CO_PROVEEDOR.CO_PRO_MAI3, dbo.CO_PROVEEDOR.CO_PRO_MAI2
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 28
         ...
         Width = 1500
         Width = 1500
         Width = 1', 'SCHEMA', N'dbo', 'VIEW', N'CO_VW_SELECT_RETENCION_ELECTRONICA', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'500
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'CO_VW_SELECT_RETENCION_ELECTRONICA', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'CO_VW_SELECT_RETENCION_ELECTRONICA', NULL, NULL
GO
